...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            // TODO: this is copied from 1070
            icpStepMap["GeForce GTX 1050"] = std::pair<int, int>(64, 240);
            rgbStepMap["GeForce GTX 1050"] = std::pair<int, int>(128, 96);
            rgbResMap["GeForce GTX 1050"] = std::pair<int, int>(256, 464);
            so3StepMap["GeForce GTX 1050"] = std::pair<int, int>(256, 48);
